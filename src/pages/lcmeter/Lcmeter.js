...
const Lcmeter = () => {
  ...
  return (
    <Container maxWidth="md">
      ...
      />
      <Body text="Kondensator: 1pF bis 1nF, 10% Abweichung Spule: 1µH bis 5µH mit 25% Abweichung, 5µH bis 1mH mit 10% Abweichung" />
      ...
      />
      <Body text=" f=1/(0,69*(R1+2*R2)*C) => f=7,39MHz" />
      <Body text="Der NE555 ist aber nur bis 500kHz spezifiziert." />
      <Body
      ...
      />
      <Body text="d% = max(log(0,5)-log(0,51), log(0,5)-log(0,49)) = 0,9% Toleranz" />
      <Body
      ...
      />
      <Body text="Leider hat die aufgebaute Schaltung schon eine Kapazität. Bei meinem Aufbau sind dies 30pF. Aus diesem Grund brauche ich keinen parallel geschalteten Kondensator." />
      <Typograph variant="h4" text="L-Messung" />
      <Body text="Für die Spulenmessung wurde ein 1nF Glimmer-Kondensator +/- 1% verwendet, weil dieser eine noch bezahlbare geringe Toleranz hat." />
      <Body
      ...
      <Body text="Das Messgerät wird mit einer 9V Blockbatterie betrieben und wird über einen Schiebeschalter eingeschaltet." />
      <Body text="Noch eine Anmerkung zum Gehäuse: Es sieht einfach nicht schön aus, aber es ist nur ein Prototyp und um Erfahrungen für das Handling zu sammeln." />
      ...
      />
      <Body text="Auch könnte ein anderer 555 Timerbausstein verwendet werden, der höhere Frequenzen erlaubt oder genauere Spannungsteiler-Widerstände enthält." />
      <Body
      ...
      <Body text="Schaltungen und der Quellcode stehen unter GPLv3." />
